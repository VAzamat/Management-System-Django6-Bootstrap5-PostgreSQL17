...
imagegallery_data=[
    ...
    },
    {
        "album": "aa34ec6e-3e8d-453d-bfdc-11c2524827f7",
        "title": "Mike Ross",
        "image": "images/ImageGallery/002_team_MikeRoss.jpg",
        "category": "Работники",
        "description": "Mike Ross — мастер динамичных кадров и безупречной логистики. Как организатор и фотограф, он видит спорт изнутри: ловит драйв соревнований и создаёт события, продуманные до мелочей. С Майком каждое мероприятие превращается в яркую историю побед.",
        "order": 1,
        "is_active": True
    }
